...
cvRouter.route("/api/v1/cv").post(jwtMidleware, checkPer("CREATE_CV"), createCvSchema, createCv);

cvRouter.route("/api/v1/cv/receive-mail").get(jwtMidleware, checkPer("RECEIVE_MAIL"), receiveMail);
